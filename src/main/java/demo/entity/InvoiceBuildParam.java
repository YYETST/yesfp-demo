...
public class InvoiceBuildParam {
     ...
     * 构造 发票作废 表单数据
     */
    private static final String lsh=buildFpqqlsh();
    ...
    public static Map<String, Object> buildInvoiceApplyDelParam() {
        ...
        requestdatas.put("FPQQLSH",lsh);
        /**
         * 销售方纳税人识别号应改为测试的
         * 删除时校验纳税人识别号是否一致
         * 理论上应从数据库拿到数据
         * */
        requestdatas.put("XSF_NSRSBH","201609140000001");
    ...
    public static Map<String, String> buildInsertWithArrayPostParam() {
        ...
        /**
         * 第一次测试 报告流水号不能重复 修改生成流水号方法 随机生成一个0-10位数字在后面拼接a拼接到20位
         *
         * 修改完后报错
         * 因为调用了两次buildFpqqlsh方法 （可能是校验）生成了两个不同的随机字符串
         * 再次修改 只调用一次buildFpqqlsh方法把他赋值到一个变量里
         * 成功
         * */
    ...
    private static String buildRequestDatas() {
        ...
        data.put("GMF_DZDH", "广州市花都区红棉大道北16号4楼4B08室 020-61796191");
